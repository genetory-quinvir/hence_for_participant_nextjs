...
function SignContent() {
  ...
  const handleSocialLogin = async (provider: SocialProvider) => {
    ...
    const baseUrl = `https://api-participant.hence.events/auth/${provider}?redirect=participant&joinPlatform=participant&callbackUrl=${encodeURIComponent(callbackUrl)}`;
